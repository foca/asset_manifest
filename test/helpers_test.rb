...
scope "when minifying" do
  ...
  test "stylesheet tag" do |assets|
    assert_html \
      %Q(<link rel="stylesheet"
               href="/css/app-CSS-CHECKSUM-MIN.min.css"
               integrity="CSS-INTEGRITY-MIN">),
      assets.stylesheet_tag("/css/app.css")
  end
  ...
  test "script tag" do |assets|
    assert_html \
      %Q(<script src="/js/app-JS-CHECKSUM-MIN.min.js"
                 integrity="JS-INTEGRITY-MIN"></script>),
      assets.script_tag("/js/app.js")
  end
